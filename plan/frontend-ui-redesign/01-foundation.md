...
**File:** `frontend/src/main.tsx` or `index.html`

- Load Fraunces + DM Sans (Google Fonts link or `@fontsource` packages)
...
- [ ] `_variables.scss` documents all Harbor Signal tokens
- [ ] Each UI primitive renders in isolation (can verify via temporary Story-less manual check in dev)
- [ ] `npm run build` passes
- [ ] No changes to `api/`, `hooks/`, `services/`, `types/`
